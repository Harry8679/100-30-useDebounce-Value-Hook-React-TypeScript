    ...
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <div className="p-6 bg-linear-to-br from-blue-50 to-purple-50 dark:from-gray-700 dark:to-gray-600 rounded-lg min-h-50 border-2 border-blue-200 dark:border-blue-800">
            {debouncedMessage ? (
